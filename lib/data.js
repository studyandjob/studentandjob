...
export async function getHeroSlides() {
  ...
  // image (e.g. a row created mid-upload). Silently skip those rather than
  // letting one bad row break the page for everyone.
  return (data || []).filter((slide) => typeof slide.image_url === 'string' && slide.image_url.trim() !== '');
}
