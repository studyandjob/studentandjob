...
export async function generateMetadata() {
  ...
  return { title: `Students Zone — ${settings.site_name || 'Education & Job Portal'}` };
}

export default async function StudentsZonePage() {
  ...
  return (
    <>
      ...
      <main className="flex-1 bg-gray-50">
        <PageBanner
          title="Students Zone"
          subtitle="Free notes, guess papers and study material — download as PDF."
          icon={
