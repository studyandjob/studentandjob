...
export default function StaffLogin({ onLoggedIn, siteName, logoUrl }) {
      ...
      <div className="w-full max-w-[420px] rounded-[22px] bg-white p-8 shadow-2xl sm:p-10">
        <div className="mb-7 text-center">
          ...
          <h1 className="font-serif text-xl font-bold text-atl">
            {siteName || 'Staff'} <em className="font-serif italic text-acoral">Staff Portal</em>
          </h1>
          <p className="mt-1 text-xs text-amuted">Staff Task Dashboard</p>
        </div>

        <h2 className="mb-6 text-center font-serif text-lg font-bold text-aink">Staff Login</h2>
        ...
        <p className="mt-4 text-center text-xs text-amuted">
          Only staff accounts created by the admin can access this dashboard.
        </p>
      </div>
    </div>
  );
