-- ============================================================
-- Educational & Job Portal — Supabase Schema (SAFE TO RE-RUN)
-- Har baar chalane par error nahi dega, chahe tables/policies
-- pehle se maujood hon ya na hon.
-- ============================================================
...
-- 9. SITE CONTACTS (Contact Us cards)
...
-- Public read access (drop first so re-running never errors)
